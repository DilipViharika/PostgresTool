...
const Styles = () => (
    <style>{`
        ...
        .tf-code-block { background:${THEME.bg}; border:1px solid ${THEME.grid}; border-radius:8px; padding:16px; margin:12px 0; max-height:300px; overflow-y:auto; position:relative; }
        ...
        .tf-code-copy { position:absolute; top:8px; right:8px; cursor:pointer; padding:8px; background:${THEME.primary}20; border-radius:6px; border:1px solid ${THEME.primary}40; color:${THEME.primary}; }
        ...
        .tf-select { background:${THEME.surfaceHover}; border:1px solid ${THEME.grid}; border-radius:8px; padding:10px 12px; color:${THEME.textMain}; font-size:13px; width:100%; cursor:pointer; }
    `}</style>
);
