...
const MOCK_ALERTS = [
    ...
    { id: 7, severity: 'info', category: 'cpu', title: 'CPU usage elevated', message: 'System CPU at 72% — elevated but within acceptable range.', created_at: new Date(Date.now() - 7200000).toISOString(), acknowledged: true, source: 'system_monitor', metric_value: '72%', threshold: '> 70%', runbook: null, rootCauseGroup: 'resource-pressure', autoResolved: true },
    { id: 8, severity: 'info', category: 'memory', title: 'Shared buffers cache miss rate increased', message: 'Cache hit ratio dropped to 97.2% from 99.8% in the last hour.', created_at: new Date(Date.now() - 10800000).toISOString(), acknowledged: true, source: 'pg_stat_bgwriter', metric_value: '97.2%', threshold: '< 98%', runbook: null, rootCauseGroup: 'resource-pressure', autoResolved: true },
