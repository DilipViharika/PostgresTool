...
import { Check, X, Key, RefreshCw, ExternalLink } from 'lucide-react';
...
const LicenseManagement: React.FC = () => {
  ...
  const handleActivate = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const errorMsg = err instanceof Error ? err.message : 'Failed to activate license';
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.section}>
        <h2 style={styles.sectionTitle}>Current License</h2>
          ...
          <div>
            <div style={styles.currentLicense}>
              <div style={styles.licenseCard}>
                ...
                <p style={styles.value}>{tier?.charAt(0).toUpperCase() + tier?.slice(1)}</p>
              </div>
              <div style={styles.licenseCard}>
      ...
      <div style={styles.section}>
        ...
        <form style={styles.form} onSubmit={handleActivate}>
          ...
          />
          <button style={styles.button} type="submit" disabled={activating}>
            {activating ? (
              <>
