...
export const LOCATIONS = ['Coimbatore', 'Hyderabad'];
...
export const AUDIT_LEVELS: Record<string, string> = {
  info: T.primary,
  warn: T.warning,
  critical: T.danger,
  success: T.success,
...
export const SESSION_RISK_COLORS: Record<string, string> = {
  low: T.success,
  high: T.warning,
  critical: T.danger,
};
