...
const StatusBadge: React.FC<StatusBadgeProps> = ({ label, color, pulse }) => (
    <span style={{
...
const RingGauge: React.FC<RingGaugeProps> = ({ value, color, size = 80, strokeWidth = 6, label, showValue = true, secondaryValue, secondaryColor }) => {
...
const MiniSparkline: React.FC<MiniSparklineProps> = ({ data = [], color = THEME.primary, width = 64, height = 20, filled = true }) => {
