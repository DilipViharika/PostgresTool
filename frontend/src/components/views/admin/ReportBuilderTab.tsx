...
const SECTION_METADATA = {
    overview: { icon: Database, label: 'Overview KPIs', color: '#00D4FF' },
    performance: { icon: Zap, label: 'Performance Metrics', color: '#2AFFD4' },
    ...
    capacity: { icon: TrendingUp, label: 'Capacity Planning', color: '#0EA5E9' },
