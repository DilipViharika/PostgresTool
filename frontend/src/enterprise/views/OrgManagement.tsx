...
const OrgManagement: React.FC = () => {
  ...
  const [loadingMemberOps, setLoadingMemberOps] = useState<LoadingMemberOps>({});
      ...
      <div style={styles.section}>
        ...
        <div style={styles.orgDetails}>
          ...
          <div style={styles.detail}>
            ...
            <p style={styles.value}>{currentOrg.slug || 'N/A'}</p>
          </div>
          <div style={styles.detail}>
          ...
          <div style={{ overflowX: 'auto' }}>
            <table style={styles.table}>
              ...
              <tbody>
                {members.map((member) => (
                  <tr key={member.id}>
                    <td style={styles.td}>{member.name || 'Unnamed User'}</td>
                    ...
                    <td style={styles.td}>{formatDate(member.lastActiveAt)}</td>
                    <td style={styles.td}>
