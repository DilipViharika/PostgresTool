# VIGIL SDK - File Reference Guide
...
### Testing
- **tests/vigil.test.js** - Unit tests (run: npm test)
...
- VigilSDK class with all methods:
...
Exports:
- VigilSDK class definition
- VigilOptions interface
...
- Keywords: vigil, monitoring, observability
- Scripts: build, test
...
| tests/vigil.test.js | 94 | 2.1 KB | Unit tests |
...
2. Check: **tests/vigil.test.js** - Test suite
...
3. Test: **tests/vigil.test.js** - Verify functionality
...
tests/
  └─> vigil.test.js (imports src/index.js)
```
...
1. **Install**: `npm install @vigil/sdk`
