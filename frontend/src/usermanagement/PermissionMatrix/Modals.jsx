...
const SCREEN_CATEGORIES = [
  ...
  },
  {
    ...
    color: '#2EE89C',
    screens: [
      { id: 'demo-pg-core',           label: 'Demo PG Core',              icon: '🐘' },
      { id: 'demo-pg-query',          label: 'Demo PG Query',             icon: '🐘' },
      { id: 'demo-pg-infra',          label: 'Demo PG Infra',             icon: '🐘' },
      { id: 'demo-pg-schema',         label: 'Demo PG Schema',            icon: '🐘' },
      { id: 'demo-pg-observability',  label: 'Demo PG Observability',     icon: '🐘' },
      { id: 'demo-pg-dev',            label: 'Demo PG Dev',               icon: '🐘' },
      { id: 'demo-pg-admin',          label: 'Demo PG Admin',             icon: '🐘' },
      { id: 'demo-mysql-core',        label: 'Demo MySQL Core',           icon: '🐬' },
      { id: 'demo-mysql-query',       label: 'Demo MySQL Query',          icon: '🐬' },
      { id: 'demo-mysql-infra',       label: 'Demo MySQL Infra',          icon: '🐬' },
      { id: 'demo-mysql-schema',      label: 'Demo MySQL Schema',         icon: '🐬' },
      { id: 'demo-mysql-observability', label: 'Demo MySQL Observability', icon: '🐬' },
      { id: 'demo-mysql-admin',       label: 'Demo MySQL Admin',          icon: '🐬' },
      { id: 'demo-mssql-core',        label: 'Demo MSSQL Core',           icon: '🔷' },
      { id: 'demo-mssql-query',       label: 'Demo MSSQL Query',          icon: '🔷' },
      { id: 'demo-mssql-infra',       label: 'Demo MSSQL Infra',          icon: '🔷' },
      { id: 'demo-mssql-schema',      label: 'Demo MSSQL Schema',         icon: '🔷' },
      { id: 'demo-mssql-observability', label: 'Demo MSSQL Observability', icon: '🔷' },
      { id: 'demo-mssql-admin',       label: 'Demo MSSQL Admin',          icon: '🔷' },
      { id: 'demo-oracle-core',       label: 'Demo Oracle Core',          icon: '🔴' },
      { id: 'demo-oracle-query',      label: 'Demo Oracle Query',         icon: '🔴' },
      { id: 'demo-oracle-infra',      label: 'Demo Oracle Infra',         icon: '🔴' },
      { id: 'demo-oracle-schema',     label: 'Demo Oracle Schema',        icon: '🔴' },
      { id: 'demo-oracle-observability', label: 'Demo Oracle Observability', icon: '🔴' },
      { id: 'demo-oracle-admin',      label: 'Demo Oracle Admin',         icon: '🔴' },
      ...
      { id: 'demo-mongo-data',        label: 'Demo Mongo Data',           icon: '🍃' },
      { id: 'demo-mongo-intelligence', label: 'Demo Mongo Intelligence',   icon: '🍃' },
      { id: 'demo-mongo-replication', label: 'Demo Mongo Replication',    icon: '🍃' },
      { id: 'demo-mongo-management',  label: 'Demo Mongo Management',     icon: '🍃' },
    ],
  },
];
