...
export function validateEncryptionConfig(): boolean {
  try {
    ...
    console.error('[Encryption] Configuration error:', (err as Error).message);
    throw err;
  }
}
 ...
 */
export function rsaDecrypt(rsaCiphertext: string | null | undefined): string | null | undefined {
 ...
 */
export function unwrapField(value: any): any {
