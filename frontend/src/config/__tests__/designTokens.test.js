 ...
 * Tests the VIGIL design system's theme definitions and switching functionality
 */
...
describe('designTokens', () => {
  ...
  describe('DS_DARK', () => {
    it('should have all required color keys', () => {
      const requiredKeys = [
        'bg', 'bgDeep', 'surface', 'surfaceHover', 'border', 'borderAccent',
        'textPrimary', 'textSub', 'textMuted', 'glowCyan', 'glowViolet',
        'shadowCard', 'shadowDeep', 'sidebarBg', 'sidebarBorder',
        'sidebarText', 'sidebarHover', 'headerBg', 'logoBg', 'logoText', 'logoSub',
        '_dark', 'fontMono', 'fontUI',
      ];
  ...
  describe('DS_ACCENTS', () => {
    it('should contain all required accent color keys', () => {
      const requiredKeys = ['cyan', 'cyanDim', 'cyanGlow', 'violet', 'violetDim', 'emerald', 'amber', 'rose', 'fontMono', 'fontUI'];
      requiredKeys.forEach(key => {
