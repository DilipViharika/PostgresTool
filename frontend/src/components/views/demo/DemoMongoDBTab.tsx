                        ...
                        return (
                            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                                ...
                                >
                                    ...
                                    <ExecStatCard value="142" label="OPERATIONS" subtitle="Last 7d" color="#6366f1" />
                                    <ExecStatCard
                                        value="99.8%"
                                        label="SUCCESS RATE"
                        ...
                        return (
                            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                                ...
                                >
                                    ...
                                    <ExecStatCard value="3" label="SHARED" subtitle="With team" color="#6366f1" />
                                    <ExecStatCard
                                        value="2h ago"
                                        label="LAST VIEWED"
                                        subtitle="Recent"
                        ...
                        return (
                            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                                ...
                                >
                                    ...
                                    <ExecStatCard value="12" label="TEMPLATES" subtitle="Available" color="#6366f1" />
                                    <ExecStatCard
                                        value="2h ago"
                                        label="LAST RUN"
                                        subtitle="On schedule"
